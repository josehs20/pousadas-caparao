...
@section('conteudo')
    ...
    <div class="modal" tabindex="-1" id="modalInfo">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title d-flex justify-content-center">Informações</h5>
                </div>
                <div class="modal-body">
                    <p>
    ...
    <div class="modal fade" id="modalTituloPrincipal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="modalTitulointroducao" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{ route('info.store') }}" method="POST">
    ...
    <div class="open-menu-div">
        ...
        <div class="alert alert-success open-menu-alert" role="alert">
            <svg class="bi flex-shrink-0 me-0" width="24" height="24" role="img" aria-label="Success:">
            ...
            <div class="row">
                <div class="col col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                    ...
                    <div class="buttons wow fadeInUp">
                        <a data-toggle="modal" data-target="#sobre" class="btn btn-primary btn-customized scroll-link"
                            href="#section-2" role="button">
    ...
    <div class="d-flex justify-content-center">
        <div id="carouselExampleIndicators" class="carousel slide carousel-fotos" data-ride="carousel">
            ...
            <div class="carousel-inner slider-s">
